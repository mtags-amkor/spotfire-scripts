...
-- &1                   SERVERDB_USER
-- &2                   SERVERDB_PASSWORD
-- &3                   SERVER_DATA_TABLESPACE
-- &4                   SERVER_TEMP_TABLESPACE
--

WHENEVER SQLERROR EXIT FAILURE

CREATE TABLESPACE &3 LOGGING 
DATAFILE SIZE 400M AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED
/

CREATE TEMPORARY TABLESPACE &4 
TEMPFILE SIZE 41472K AUTOEXTEND ON NEXT 20736K MAXSIZE 800M
