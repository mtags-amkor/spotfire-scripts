...
sqlplus ${ADMINNAME}/${ADMINPASSWORD}@${CONNECTIDENTIFIER} @create_actionlog_env.sql  "${ROOTFOLDER}" "${ACTIONDB_USER}" "${ACTIONDB_PASSWORD}" "${ACTIONDB_DATA_TABLESPACE}" "${ACTIONDB_TEMP_TABLESPACE}" > actionlog.txt
